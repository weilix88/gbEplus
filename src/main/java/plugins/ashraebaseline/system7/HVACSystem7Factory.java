...
/**
 * This class represent HVAC system type 7 manufacturer The class behaviors
 ...
 * implemented) G3.1.1.3 (nOT implemented) 4. Manufacture correct system type 7
...
public class HVACSystem7Factory {
	...
	public HVACSystem7Factory(CampusTranslator campus) {
		systemObjects = new HashMap<String, ArrayList<EplusObject>>();
		processTemplate();
		systemType7 = new HVACSystem7(systemObjects, campus);
